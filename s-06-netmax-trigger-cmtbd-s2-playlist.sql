...
--@Descripción: Trigger PLAYLIST para cmtbd_s2
    ...
    case
        when inserting then
            ...
            -- Inserción remota
                ...
                -- Verifica si hay correspondencia con el sitio cmtbd_s1
                select count(*) into v_count
                from usuario_f1
                where usuario_id = :new.usuario_id;

                if v_count > 0 then
                    -- Inserta el registro en cmtbd_s1
        ...
        when deleting then
            ...
            if v_count > 0 then
                ...
                if v_count > 0 then
                    --  Elimina el registro en cmtbd_s1
