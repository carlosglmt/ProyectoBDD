...
CREATE TABLE DOCUMENTAL_F1_CMT_S1(
    ...
    CONSTRAINT DOCUMENTAL_F1_CMT_S1_PK PRIMARY KEY (PROGRAMA_ID)
)
;
...
CREATE TABLE PAIS_R_CMT_S1(
    ...
    CONSTRAINT PAIS_R_CMT_S1_PK PRIMARY KEY (PAIS_ID)
)
;
...
CREATE TABLE PELICULA_F1_CMT_S1(
    ...
    CONSTRAINT PELICULA_F1_CMT_S1_PK PRIMARY KEY (PROGRAMA_ID)
)
;
...
CREATE TABLE PLAYLIST_F1_CMT_S1(
    ...
    CONSTRAINT PLAYLIST_F1_CMT_S1_PK PRIMARY KEY (PLAYLIST_ID)
)
;
...
CREATE TABLE PROGRAMA_F1_CMT_S1(
    ...
    CONSTRAINT PROGRAMA_F1_CMT_S1_PK PRIMARY KEY (PROGRAMA_ID)
)
;
...
CREATE TABLE SERIE_F1_CMT_S1(
    ...
    CONSTRAINT SERIE_F1_CMT_S1_PK PRIMARY KEY (PROGRAMA_ID)
)
;
...
CREATE TABLE TIPO_CUENTA_R_CMT_S1(
    ...
    CONSTRAINT TIPO_CUENTA_R_CMT_S1_PK PRIMARY KEY (TIPO_CUENTA_ID)
)
;
...
CREATE TABLE TIPO_SERIE_R_CMT_S1(
    ...
    CLAVE            VARCHAR2(40)     NOT NULL,
    DESCRIPCION      VARCHAR2(500)    NOT NULL,
    CONSTRAINT TIPO_SERIE_R_CMT_S1_PK PRIMARY KEY (TIPO_SERIE_ID)
)
;
...
CREATE TABLE USUARIO_F1_CMT_S1(
    ...
    TIPO_CUENTA_ID      NUMBER(2, 0)     NOT NULL,
    CONSTRAINT USUARIO_F1_CMT_S1_PK PRIMARY KEY (USUARIO_ID)
)
;
...
ALTER TABLE DOCUMENTAL_F1_CMT_S1 ADD CONSTRAINT DOCUMENTAL_F1_CMT_S1_PROGRAMA_ID_FK
    FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F1_CMT_S1(PROGRAMA_ID)
;

ALTER TABLE DOCUMENTAL_F1_CMT_S1 ADD CONSTRAINT DOCUMENTAL_F1_CMT_S1_PAIS_ID_FK
    FOREIGN KEY (PAIS_ID)
...
ALTER TABLE PELICULA_F1_CMT_S1 ADD CONSTRAINT PELICULA_F1_CMT_S1_PROGRAMA_ID_FK
    FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F1_CMT_S1(PROGRAMA_ID)
;
...
ALTER TABLE PLAYLIST_F1_CMT_S1 ADD CONSTRAINT PLAYLIST_F1_CMT_S1_USUARIO_ID_FK
...
ALTER TABLE PROGRAMA_F1_CMT_S1 ADD CONSTRAINT PROGRAMA_F1_CMT_S1_STATUS_PROGRAMA_ID
...
ALTER TABLE SERIE_F1_CMT_S1 ADD CONSTRAINT SERIE_F1_CMT_S1_PROGRAMA_ID_FK
    FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F1_CMT_S1(PROGRAMA_ID)
;

ALTER TABLE SERIE_F1_CMT_S1 ADD CONSTRAINT SERIE_F1_CMT_S1_TIPO_SERIE_ID_FK
...
ALTER TABLE USUARIO_F1_CMT_S1 ADD CONSTRAINT USUARIO_F1_CMT_S1_TIPO_CUENTA_ID_FK
