...
create or replace synonym tipo_cuenta_r2 for tipo_cuenta_r_cmt_s2;
...
create or replace synonym pais_r2 for pais_r_cmt_s2;
...
create or replace synonym tipo_serie_r2 for tipo_serie_cmt_s2;
