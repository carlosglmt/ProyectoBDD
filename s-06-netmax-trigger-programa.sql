    ...
    case
        when inserting then
            ...
            if substr(:new.folio,1,2) >= 'AA' and substr(:new.folio,1,2) <= 'MZ' then
                ...
                values (:new.programa_id,:new.folio,:new.nombew,:new.descripcion,:new.fecha_status,
            ...
            -- Verificando si el nuevo registro pertenecerá al sitio msebd_s1
                ...
                if :new.status_programa = 3 or :new.status_programa = 2 or :new.status_programa = 1 then
                ...
                elsif :new.status_programa = 4 or :new.status_programa = 5 then
        ...
        when deleting then
            ...
            -- Verificando si el registro a eliminar está en el sitio msebd_s1
                ...
                if :old.status_programa = 3 or :old.status_programa = 2 or :old.status_programa = 1 then
                    delete from programa_f2 where programa_id = :old.programa_id;

                -- Verificando si el registro a eliminar está en el sitio msebd_s2
                elsif :old.status_programa = 4 or :old.status_programa = 5 then
