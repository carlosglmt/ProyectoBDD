...
--@Descripción: Creación de sinónimos para CMTBD_S2
...
create or replace synonym usuario_f3 for usuario_f3_cmt_s2;
...
create or replace synonym playlist_f3 for playlist_f3_cmt_s2;
...
-- TIPO_CUENTA
create or replace synonym tipo_cuenta_r1 for tipo_cuenta_r_cmt_s2;
create or replace synonym tipo_cuenta_r2 for tipo_cuenta_r_cmt_s1@cmtbd_s1;
...
-- PAIS
create or replace synonym pais_r1 for pais_r_cmt_s2;
create or replace synonym pais_r2 for pais_r_cmt_s1@cmtbd_s1;
create or replace synonym pais_r3 for pais_r_mse_s1@msebd_s1;
create or replace synonym pais_r4 for pais_r_mse_s2@msebd_s2;

-- TIPO_SERIE
create or replace synonym tipo_serie_r1 for tipo_serie_r_cmt_s2;
create or replace synonym tipo_serie_r2 for tipo_serie_r_cmt_s1@cmtbd_s1;
