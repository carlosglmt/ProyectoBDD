...
CREATE TABLE ARCHIVO_PROGRAMA_F1_MSE_S2(
    ...
    CONSTRAINT ARCHIVO_PROGRAMA_F1_MSE_S2_PK PRIMARY KEY (NUM_ARCHIVO, PROGRAMA_ID)
)
;
...
CREATE TABLE DOCUMENTAL_F3_MSE_S2(
    ...
    CONSTRAINT DOCUMENTAL_F3_MSE_S2_PK PRIMARY KEY (PROGRAMA_ID)
)
;
...
-- 
-- TABLE: HISTORICO_STATUS_PROGRAMA_F1_MSE_S2 
--

CREATE TABLE HISTORICO_STATUS_PROGRAMA_F1_MSE_S2(
    HISTORICO_STATUS_PROG_ID    NUMBER(10, 0)    NOT NULL,
    FECHA_STATUS                DATE             NOT NULL,
    STATUS_PROGRAMA_ID          NUMBER(2, 0)     NOT NULL,
    PROGRAMA_ID                 NUMBER(10, 0)    NOT NULL,
    CONSTRAINT HISTORICO_STATUS_PROGRAMA_F1_MSE_S2_PK PRIMARY KEY (HISTORICO_STATUS_PROG_ID)
)
;
...
CREATE TABLE PAIS_R_MSE_S2(
    ...
    CONSTRAINT PAIS_R_MSE_S2_PK PRIMARY KEY (PAIS_ID)
)
;
...
CREATE TABLE PELICULA_F3_MSE_S2(
    ...
    CONSTRAINT PELICULA_F3_MSE_S2_PK PRIMARY KEY (PROGRAMA_ID)
)
;
...
CREATE TABLE PLAYLIST_F4_MSE_S2(
    ...
    CONSTRAINT PLAYLIST_F4_MSE_S2_PK PRIMARY KEY (PLAYLIST_ID)
)
;
...
CREATE TABLE PROGRAMA_F3_MSE_S2(
    ...
    STATUS_PROGRAMA_ID    NUMBER(2, 0)     NOT NULL,
    CONSTRAINT PROGRAMA_F3_MSE_S2_PK PRIMARY KEY (PROGRAMA_ID)
)
;
...
CREATE TABLE SERIE_F3_MSE_S2(
    ...
    CONSTRAINT SERIE_F3_MSE_S2_PK PRIMARY KEY (PROGRAMA_ID)
)
;
...
CREATE TABLE TIPO_CUENTA_R_MSE_S2(
    ...
    CONSTRAINT TIPO_CUENTA_R_MSE_S2_PK PRIMARY KEY (TIPO_CUENTA_ID)
)
;
...
CREATE TABLE TIPO_SERIE_R_MSE_S2(
    ...
    CLAVE            VARCHAR2(40)     NOT NULL,
    DESCRIPCION      VARCHAR2(500)    NOT NULL,
    CONSTRAINT TIPO_SERIE_R_MSE_S2_PK PRIMARY KEY (TIPO_SERIE_ID)
)
;
...
CREATE TABLE USUARIO_F5_MSE_S2(
    ...
    TIPO_CUENTA_ID      NUMBER(2, 0)     NOT NULL,
    CONSTRAINT USUARIO_F5_MSE_S2_PK PRIMARY KEY (USUARIO_ID)
)
;
...
ALTER TABLE DOCUMENTAL_F3_MSE_S2 ADD CONSTRAINT DOCUMENTAL_F3_MSE_S2_PROGRAMA_ID_FK
    FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F3_MSE_S2(PROGRAMA_ID)
;

ALTER TABLE DOCUMENTAL_F3_MSE_S2 ADD CONSTRAINT DOCUMENTAL_F3_MSE_S2_PAIS_ID_FK
    FOREIGN KEY (PAIS_ID)
...
ALTER TABLE HISTORICO_STATUS_PROGRAMA_F1_MSE_S2 ADD CONSTRAINT HISTORICO_STATUS_PROGRAMA_F1_MSE_S2_STATUS_PROGRAMA_ID_FK
...
ALTER TABLE PELICULA_F3_MSE_S2 ADD CONSTRAINT PELICULA_F3_MSE_S2_PROGRAMA_ID_FK
    FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F3_MSE_S2(PROGRAMA_ID)
;
...
ALTER TABLE PLAYLIST_F4_MSE_S2 ADD CONSTRAINT PLAYLIST_F4_MSE_S2_USUARIO_ID_FK
...
ALTER TABLE PROGRAMA_F3_MSE_S2 ADD CONSTRAINT PROGRAMA_F3_MSE_S2_STATUS_PROGRAMA_ID_FK
    FOREIGN KEY (STATUS_PROGRAMA_ID)
    REFERENCES STATUS_PROGRAMA(STATUS_PROGRAMA_ID)
;
...
ALTER TABLE SERIE_F3_MSE_S2 ADD CONSTRAINT SERIE_F3_MSE_S2_PROGRAMA_ID_FK
    FOREIGN KEY (PROGRAMA_ID)
    REFERENCES PROGRAMA_F3_MSE_S2(PROGRAMA_ID)
;

ALTER TABLE SERIE_F3_MSE_S2 ADD CONSTRAINT SERIE_F3_MSE_S2_TIPO_SERIE_ID_FK
...
ALTER TABLE USUARIO_F5_MSE_S2 ADD CONSTRAINT USUARIO_F5_MSE_S2_TIPO_CUENTA_ID_FK
