...
--Funcion que obtiene BLOB del fragmento 1
create or replace function get_remote_archivo_f1_by_id(v_id in number)
    return blob is
    pragma autonomous_transaction;
    v_temp_archivo blob;
begin
...
--Funcion que obtiene BLOB del fragmento 2
create or replace function get_remote_archivo_f2_by_id(v_id in number)
    return blob is
    pragma autonomous_transaction;
    v_temp_archivo blob;
begin
